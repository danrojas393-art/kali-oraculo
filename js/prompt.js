const SYSTEM_PROMPT_MASTER = ({ nombre1, signo1, elemento1, nombre2, signo2, elemento2, estadoVinculo, puntuacion }) => `Actúa como el Oráculo Kali, una consejera mística, empática, profunda y astrológicamente certera.
